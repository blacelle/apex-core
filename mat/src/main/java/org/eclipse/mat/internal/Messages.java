...
public class Messages
{
    ...
    public static final String ClassSpecificNameResolverRegistry_Error_CreateResolver = "Error while creating name resolver ''{0}''";
    public static final String ClassSpecificNameResolverRegistry_Error_MissingObject = "No object to resolve class specific name for.";
    public static final String ClassSpecificNameResolverRegistry_Error_MissingSubjects = "Resolver without subjects: ''{0}''";
    public static final String ClassSpecificNameResolverRegistry_Error_Resolving = "Error resolving name of {0}";
    public static final String ClassSpecificNameResolverRegistry_ErrorMsg_DuringResolving = "Error resolving name of {0}";
    public static final String ClassSpecificNameResolverRegistry_ErrorMsg_MissingSubject = "Resolver without subjects: ''{0}''";
    public static final String ClassSpecificNameResolverRegistry_ErrorMsg_WhileCreatingResolver = "Error while creating name resolver ''{0}''";
    ...
    public static final String CollectionFillRatioQuery_ErrorMsg_AllArgumentsMustBeSet = "If the collection argument is set to a custom (e.g. non-JDK) collection class, the size_attribute and array_attribute argument must be set. Otherwise, the query cannot calculate the fill ratio.";
    ...
    public static final String CollectionUtil_BadBackingArray = "Field ''{0}'' of {1} contains {2} instead of an array of objects as a backing array";
    ...
    public static final String CollectionsBySizeQuery_ErrorMsg_ArgumentMissing = "If the collection argument is set to a custom (e.g. non-JDK) collection class, the size_attribute must be set. Otherwise, the query cannot determine the size of the collection.";
    ...
    public static final String CompareTablesQuery_SymmetricDifferenceFirst = "Symmetric difference of Table {0}, Table {1}";
    ...
    public static final String CompareTablesQuery_SymmetricDifferenceOf2 = "Symmetric difference of Table {0} and Table {1}";
    ...
    public static final String ComponentReportQuery_DetectedEmptyCollections = "Detected the following empty collections:";
    ...
    public static final String ComponentReportQuery_HistogramFinalizeMethod = "Histogram of Objects with Finalize Method";
    ...
    public static final String ComponentReportQuery_Msg_DetectedCollectionFillRatios = "Detected the following collections with fill ratios below 20%:";
    public static final String ComponentReportQuery_Msg_DetectedCollisionRatios = "Detected the following maps with collision ratios above 80%:";
    public static final String ComponentReportQuery_Msg_FoundOccurrences = "Found {0,number} occurrences of char[] with at least 10 instances having identical content. Total size is {1} bytes.";
    public static final String ComponentReportQuery_Msg_InstancesRetainBytes = "{0,number} instances of <strong>{1}</strong> retain <strong>{2}</strong> bytes.";
    public static final String ComponentReportQuery_Msg_NoAliveSoftReferences = "Component does not keep Soft References alive.";
    public static final String ComponentReportQuery_Msg_NoAliveWeakReferences = "Component does not keep Weak References alive.";
    public static final String ComponentReportQuery_Msg_NoCollisionRatiosFound = "No maps found with collision ratios greater than 80%.";
    public static final String ComponentReportQuery_Msg_NoExcessiveEmptyCollectionsFound = "No excessive usage of empty collections found.";
    public static final String ComponentReportQuery_Msg_NoFinalizerFound = "Component does not keep object with Finalizer methods alive.";
    public static final String ComponentReportQuery_Msg_NoFinalizerObjects = "Heap dump contains no java.lang.ref.Finalizer objects.<br/>IBM VMs implement Finalizer differently and are currently not supported by this report.";
    public static final String ComponentReportQuery_Msg_NoLowFillRatiosFound = "No serious amount of collections with low fill ratios found.";
    public static final String ComponentReportQuery_Msg_NoSoftReferencesFound = "Heap dump contains no soft references.";
    public static final String ComponentReportQuery_Msg_NoWeakReferencesFound = "Heap dump contains no weak references.";
    public static final String ComponentReportQuery_Msg_SoftReferencesFound = "A total of {0} java.lang.ref.SoftReference object{0,choice,0\\#s|1\\#|2\\#s} have been found, which softly reference {1,choice,0\\#no objects|1\\#one object|2\\#{1,number} objects}.";
    public static final String ComponentReportQuery_Msg_SoftReferencesRetained = "{0,choice,0\\#No objects|1\\#one object|2\\#{0,number} objects} totalling {1} are retained (kept alive) only via soft references.";
    public static final String ComponentReportQuery_Msg_SoftReferencesStronglyRetained = "{0,choice,0\\#No objects|1\\#One object|2\\#{0,number} objects} totalling {1} are softly referenced and also strongly retained (kept alive) via soft references.";
    public static final String ComponentReportQuery_Msg_TotalFinalizerMethods = "A total of {0} object{0,choice,0\\#s|1\\#|2\\#s} implement the finalize method.";
    public static final String ComponentReportQuery_Msg_WeakReferencesFound = "A total of {0} java.lang.ref.WeakReference object{0,choice,0\\#s|1\\#|2\\#s} have been found, which weakly reference {1,choice,0\\#no objects|1\\#one object|2\\#{1,number} objects}.";
    public static final String ComponentReportQuery_Msg_WeakReferencesRetained = "{0,choice,0\\#No objects|1\\#One object|2\\#{0,number} objects} totalling {1} are retained (kept alive) only via weak references.";
    public static final String ComponentReportQuery_Msg_WeakReferencesStronglyRetained = "{0,choice,0\\#No objects|1\\#One object|2\\#{0,number} objects} totalling {1} are weakly referenced and also strongly retained (kept alive) via weak references.";
    ...
    public static final String EquinoxBundleReader_CannotFindContributorID = "Could not parse contributorId. Expected a number but got \"{0}\"";
    public static final String EquinoxBundleReader_ErrorMsg_BundleNotFound = "Bundle host not found: 0x{0}";
    public static final String EquinoxBundleReader_ErrorMsg_DuplicateConfigurationElement = "Duplicate configuration element: {0}, first object address: 0x{1}, second object address: 0x{2}";
    public static final String EquinoxBundleReader_ErrorMsg_DuplicateExtension = "Duplicate extension: {0}, first object address: 0x{1}, second object address: 0x{2}";
    public static final String EquinoxBundleReader_ErrorMsg_DuplicateExtensionPoint = "Duplicate extension point: {0}, first object address: 0x{1}, second object address: 0x{2}";
    public static final String EquinoxBundleReader_ErrorMsg_ExpectedArrayType = "Expected array type: 0x{0}";
    public static final String EquinoxBundleReader_ErrorMsg_ExpectedFieldExtraInformation = "Expected ''extraInformation'': 0x{0}";
    public static final String EquinoxBundleReader_ErrorMsg_ExpectedFieldObjectId = "Expected field ''objectId'': 0x{0}";
    public static final String EquinoxBundleReader_ErrorMsg_ExpectedFieldParent = "Expected field ''parentId'': 0x{0}";
    public static final String EquinoxBundleReader_ErrorMsg_ExpectedStringArray = "Expected ''propertiesAndValues'' in String[] format: 0x{0}";
    public static final String EquinoxBundleReader_ErrorMsg_ReadingProperty = "Error reading property of ConfigurationElement: 0x{0}";
    ...
    public static final String EquinoxBundleReader_ErrorMsg_SoftReferencesNotHandled = "Extension 0x{0} has properties in the form of SoftReference. Not handled.";
    public static final String EquinoxBundleReader_ErrorMsg_UnknownElementType = "Unknown element 0x{0} of type {1}";
    public static final String EquinoxBundleReader_ExpectedFieldContributorId = "Expected field ''contributorId'': 0x{0}";
    public static final String EquinoxBundleReader_ExpectedFieldPropertiesAndValues = "Expected field ''propertiesAndValues'': 0x{0}";
    ...
    public static final String FinalizerQueueQuery_ErrorMsg_MultipleFinalizerClasses = "Error: Snapshot contains multiple java.lang.ref.Finalizer classes.";
    public static final String FinalizerQueueQuery_Msg_ExtractingObjects = "Extracting objects ready for finalization from queue...";
    public static final String FinalizerQueueQuery_ReadyForFinalizerThread = "Ready for Finalizer Thread";
    public static final String FinalizerQueueQuery_ReadyForFinalizerThread_Histogram = "Ready for Finalizer Thread - Histogram";
    public static final String FinalizerQueueQuery_ReadyForFinalizerThread_List = "Ready for Finalizer Thread - Object List";
    public static final String FinalizerReferenceStatQuery_Label_Referenced = "Histogram of Objects Referenced by Finalizer";
    public static final String FinalizerReferenceStatQuery_Label_Retained = "Only Retained through Finalizer";
    public static final String FinalizerReferenceStatQuery_Label_StronglyRetainedReferents = "Referents strongly retained by finalizer references";
    public static final String FinalizerThreadQuery_ErrorMsg_FinalizerThreadInstanceNotFound = "Instance of class java.lang.ref.Finalizer$FinalizerThread not found in heap dump.";
    public static final String FinalizerThreadQuery_ErrorMsg_FinalizerThreadNotFound = "Class java.lang.ref.Finalizer$FinalizerThread not found in heap dump.";
    public static final String FinalizerThreadQuery_ErrorMsg_MultipleFinalizerThreadClasses = "Error: Snapshot contains multiple instances of java.lang.ref.Finalizer$FinalizerThread class.";
    public static final String FinalizerThreadQuery_ErrorMsg_MultipleThreadClassesFound = "Error: Snapshot contains multiple java.lang.Thread classes.";
    public static final String FinalizerThreadQuery_ErrorMsg_MultipleThreads = "Error: Snapshot contains multiple java.lang.ref.Finalizer$FinalizerThread classes.";
    public static final String FinalizerThreadQuery_ErrorMsg_ThreadClassNotFound = "Class java.lang.Thread not found in heap dump.";
    public static final String FinalizerThreadQuery_ErrorMsg_ThreadInstanceNotFound = "Instance of class java.lang.Thread not found in heap dump.";
    ...
    public static final String FindLeaksQuery_TooManySuspects = "Too many suspect instances ({0}). Will use {1} random from them to search for common path.";
    ...
    public static final String HashEntriesQuery_ErrorMsg_MissingArguments = "If the map argument is set to a custom (e.g. non-JDK) collection class, the array_attribute, key_attribute and value_attribute arguments must be set. Otherwise, the query cannot determine the contents of the map.";
    public static final String HashEntriesQuery_Msg_Extracting = "Extracting Key Value Pairs...";
    public static final String HashSetValuesQuery_ErrorMsg_MissingArgument = "If the collection argument is set to a custom (e.g. non-JDK) collection class, the array_attribute and key_attribute arguments must be set. Otherwise, the query cannot determine the contents of the hash set.";
    ...
    public static final String HeapDumpProviderRegistry_ErrorGettingArgumentErrorMsg = "Error get argument ''{0}'' of class ''{1}''";
    public static final String HeapDumpProviderRegistry_NameAlreadyBouneErrorMsg = "Heap dump adapter name ''{0}'' is already bound to {1}\\!";
    public static final String HeapDumpProviderRegistry_UnableToAccessArgumentErrorMsg = "Unable to access argument ''{0}'' of class ''{1}''. Make sure the attribute is PUBLIC.";
    public static final String HeapDumpProviderRegistry_WrongTypeErrorMsg = "Field {0} of {1} has advice {2} but is not of type {3}.";
    public static final String HeapObjectArgumentFactory_ErrorMsg_MultipleObjects = "Argument ''{0}'' expects one object not {1} objects";
    public static final String HeapObjectArgumentFactory_ErrorMsg_SettingField = "{0}: Error setting heap objects to field ''{1}''";
    public static final String HeapObjectArgumentFactory_ErrorMsg_TypeNotSupported = "Type ''{0}'' of argument ''{1}'' not supported.";
    ...
    public static final String HeapObjectParamArgument_ErrorMsg_NotAClass = "Not a class: 0x{0} ({2}). If specifying ''{3}'', the selected objects all must be classes.";
    public static final String HeapObjectParamArgument_ErrorMsg_NotAClassLoader = "Not a class loader: 0x{0} ({2}). If specifying ''{3}'', the selected objects all must be class loaders.";
    public static final String HeapObjectParamArgument_ErrorMsg_NotAListOfObjects = "OQL query does not return a list of objects: {0}";
    ...
    public static final String HeapObjectParamArgument_Msg_MatchingPattern = "{0} classes ({1} instances) are matching the pattern";
    public static final String HeapObjectParamArgument_Msg_ObjectFound = "Object 0x{0} not found";
    public static final String HeapObjectParamArgument_Msg_SearchingByPattern = "Looking up objects for class name pattern ''{0}''";
    ...
    public static final String Histogram_Description = "Histogram {0} with {1} class loaders, {2} classes, {3} objects, {4} used heap bytes:";
    ...
    public static final String InspectionAssert_NotSupported = "Dump format ''{0}'' does not support inspection ''{1}''.";
    ...
    public static final String JettyRequestResolver_Msg_ThreadExecutesHTTPRequest = "The thread is executing an HTTP Request to <strong>{0}</strong>.";
    ...
    public static final String LeakHunterQuery_AccumulatedObjectsByClass = "Accumulated Objects by Class in Dominator Tree";
    ...
    public static final String LeakHunterQuery_ErrorShortestPaths = "Error creating shortest paths to accumulation point.";
    ...
    public static final String LeakHunterQuery_Msg_AccumulatedBy = "The memory is accumulated in classloader/component <b>&quot;{0}&quot;</b>.";
    public static final String LeakHunterQuery_Msg_AccumulatedByInstance = "The memory is accumulated in one instance of <b>&quot;{0}&quot;</b> loaded by <b>&quot;{1}&quot;</b>.";
    public static final String LeakHunterQuery_Msg_AccumulatedByLoadedBy = "The memory is accumulated in class <b>&quot;{0}&quot;</b>, loaded by <b>&quot;{1}&quot;</b>.";
    public static final String LeakHunterQuery_Msg_Bytes = "{0} bytes. ";
    public static final String LeakHunterQuery_Msg_Class = "The class <b>&quot;{0}&quot;</b>, loaded by <b>&quot;{1}&quot;</b>, occupies <b>{2}</b> bytes. ";
    public static final String LeakHunterQuery_Msg_ClassLoader = "The classloader/component <b>&quot;{0}&quot;</b> occupies <b>{1}</b> bytes. ";
    public static final String LeakHunterQuery_Msg_Instance = "One instance of <b>&quot;{0}&quot;</b> loaded by <b>&quot;{1}&quot;</b> occupies <b>{2}</b> bytes. ";
    public static final String LeakHunterQuery_Msg_InstancesOccupy = "{0} instances of <b>&quot;{1}&quot;</b>, loaded by <b>&quot;{2}&quot;</b> occupy <b>{3}</b> bytes. ";
    public static final String LeakHunterQuery_Msg_ReferencedBy = "The instance is referenced by classloader/component. <b>&quot;{0}&quot;</b>. ";
    public static final String LeakHunterQuery_Msg_ReferencedByClass = "The instance is referenced by class <b>&quot;{0}&quot;</b>, loaded by <b>&quot;{1}&quot;</b>. ";
    public static final String LeakHunterQuery_Msg_ReferencedByInstance = "The instance is referenced by <b>{0}</b>&nbsp;, loaded by <b>&quot;{1}&quot;</b>. ";
    public static final String LeakHunterQuery_Msg_ReferencedFromClass = "These instances are referenced from the class <b>&quot;{0}&quot;</b>, loaded by <b>&quot;{1}&quot;</b>";
    public static final String LeakHunterQuery_Msg_ReferencedFromClassLoader = "These instances are referenced from classloader/component <b>&quot;{0}&quot;</b>";
    public static final String LeakHunterQuery_Msg_ReferencedFromInstance = "These instances are referenced from one instance of <b>&quot;{0}&quot;</b>, loaded by <b>&quot;{1}&quot;</b>";
    public static final String LeakHunterQuery_Msg_SuspectsRelated = "The problem suspects {0} and {1} may be related, because the reference chains to them have a common beginning.";
    public static final String LeakHunterQuery_Msg_Thread = "The thread <b>{0}</b> keeps local variables with total size <b>{1}</b> bytes.";
    ...
    public static final String MapCollisionRatioQuery_CalculatingCollisionRatios = "Calculating Map Collision Ratios...";
    ...
    public static final String MapCollisionRatioQuery_ErrorMsg_MissingArgument = "If the collection argument is set to a custom (e.g. non-JDK) collection class, the size_attribute and array_attribute argument must be set. Otherwise, the query cannot calculate the collision ratio.";
    ...
    public static final String MultiplePath2GCRootsQuery_Group_FromGCRootsOnClass = "Merge Paths from GC Roots on Class";
    ...
    public static final String ObjectTreeFactory_ErrorMsg_addChild = "\\#addChild must be called after a root object has been added.";
    public static final String ObjectTreeFactory_ErrorMsg_addChildren = "\\#addChildren must be called after a root object has been added.";
    ...
    public static final String ParseSnapshotApp_MultipleSnapshotsDetected = "Multiple heap dump snapshots have been detected in the file being analyzed. Use the 'runtime_identifier' option to select which snapshot to process.";
    ...
    public static final String PhantomReferenceStatQuery_Label_StronglyRetainedReferents = "Referents strongly retained by phantom references";
    public static final String PieFactory_ErrorMsg_NoSnapshotAvailable = "No snapshot available. Use new PieFactory(snapshot) instead.";
    ...
    public static final String PrimitiveArraysWithAConstantValueQuery_SearchingArrayValues = "Searching array values...";
    public static final String ReferenceQuery_ErrorMsg_NoMatchingClassesFound = "No classes matching pattern {0}";
    public static final String ReferenceQuery_Msg_ComputingReferentSet = "Computing Referent Set (objects referenced by the Reference objects)...";
    public static final String ReferenceQuery_Msg_ComputingRetainedSet = "Computing retained set of reference set (assuming only the referents are no longer referenced by the Reference objects)...";
    public static final String ReferenceQuery_Msg_ComputingStronglyRetainedSet = "Computing strongly retained set of reference set...";
    ...
    public static final String ReferenceQuery_StronglyRetainedByReferences = "Referents strongly retained by references";
    public static final String RetainedSetQuery_RetainedBy = "Retained by ''{0}''";
    public static final String RetainedSizeDerivedData_Error_IllegalContext = "Context provider ''{0}'' returned an illegal context object set for ''{1}'' with content ''{2}''. Return null instead.";
    public static final String RetainedSizeDerivedData_Error_IllegalObjectId = "Context provider ''{0}'' returned an context object with an illegeal object id for ''{1}''. Return null instead.";
    public static final String RetainedSizeDerivedData_ErrorMsg_IllegalContextObject = "Context provider ''{0}'' returned an illegal context object set for ''{1}}'' with content ''{{2}}'''. Return null instead.";
    public static final String RetainedSizeDerivedData_ErrorMsg_IllegalObjectId = "Context provider ''{0}'' returned an context object with an illegeal object id for ''{1}}''. Return null instead.";
    public static final String RetainedSizeDerivedData_Label_Approximate = "Calculate Minimum Retained Size (quick approx.)";
    public static final String RetainedSizeDerivedData_Label_Precise = "Calculate Precise Retained Size";
    public static final String Service_ErrorMsg_MismatchKeysServices = "Number of keys does not correspond to the number of values for the service: 0x{0}";
    ...
    public static final String SnapshotQuery_ErrorMsg_UnsuitableSubjects = "Query {0} has unsuitable Subjects {1} for the snapshot";
    public static final String SnapshotQuery_ErrorMsg_UnsupportedTyp = "Unsupported type for argument {0}: {1}\n(Use: IObject, Integer, int[], ArrayInt, IHeapObjectArgument)";
    ...
    public static final String SoftReferenceStatQuery_Label_StronglyRetainedReferents = "Referents strongly retained by soft reference";
    public static final String SubjectRegistry_Error_MissingAnnotation = "Missing or empty @Subject(s) annotation: ''{0}''";
    public static final String SubjectRegistry_ErrorMsg_MissingSubjectAnnotation = "Missing or empty @Subject(s) annotation: ''{0}''";
    ...
    public static final String TopConsumers2Query_BiggestClassesOverview = "Biggest Top-Level Dominator Classes (Overview)";
    public static final String TopConsumers2Query_BiggestClassLoaders = "Biggest Top-Level Dominator Class Loaders";
    public static final String TopConsumers2Query_BiggestClassLoadersOverview = "Biggest Top-Level Dominator Class Loaders (Overview)";
    ...
    public static final String TopConsumersQuery_ColumnLabels = "package,  retained%,  retained bytes, \\#top-dominators";
    ...
    public static final String VmInfoDescriptor_ErrorGettingArgumentErrorMsg = "Error get argument ''{0}'' of class ''{1}''";
    public static final String VmInfoDescriptor_UnableToAccessArgumentErrorMsg = "Unable to access argument ''{0}'' of class ''{1}''. Make sure the attribute is PUBLIC.";
    public static final String VmInfoDescriptor_WrongTypeErrorMsg = "Field {0} of {1} has advice {2} but is not of type {3}.";
    ...
    public static final String WeakReferenceStatQuery_Label_StronglyRetainedReferents = "Referents strongly retained by weak references";
