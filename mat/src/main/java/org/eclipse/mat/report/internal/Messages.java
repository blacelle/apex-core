...
public final class Messages
{
    ...
    public static final String ArgumentSet_Error_IllegalArgument = "Illegal argument: {0} of type {1} cannot be set to field {2} of type {3}";
    ...
    public static final String ArrayLong_Error_LengthExceeded = "Requested length of new long[{0}] exceeds limit of {1}";
    public static final String CategoryDescriptor_Label_NoCategory = "<uncategorized>";
    public static final String CommandLine_Error_AssignmentFailed = "''{0}'' cannot be assigned. Argument ''{1}'' is already set.";
    ...
    public static final String CommandLine_Error_NoUnflaggedArguments = "No unflagged parameters available for argument ''{0}''";
    ...
    public static final String ContextDerivedData_Error_OperationNotFound = "Mismatch: Operation ''{0}'' not found in ''{1}''";
    ...
    public static final String Filter_Error_Parsing = "Error parsing the filter expression.\n\nUse one of the following:\nIntervals: 1000..10000  1%..10%\nUpper Boundary: < = \"10000 <1%\nLower Boundary: >1000 > = \"5%\n\n";
    ...
    public static final String PageSnippets_Label_CreatedBy = "Created by <a href = \"http://www.eclipse.org/mat/\" target = \"_blank\">Eclipse Memory Analyzer</a>";
    ...
    public static final String Quantize_Error_MismatchArgumentsColumns = "Mismatch between number of arguments and number of columns";
    ...
    public static final String QueryContextImpl_ImpossibleToConvert = "Impossible to convert any string to {0}, query is not suitable for this snapshot";
    ...
    public static final String QueryPart_Error_InvalidProvider = "Invalid configuration parameter {0}: expected <provider> = \"<operation>: {1}";
    public static final String QueryPart_Error_InvalidProviderOperation = "Invalid configuration parameter {0}: unknown operation: {1}";
    ...
    public static final String QueryPart_Error_RetainedSizeColumnNotFound = "Error added retained size column for ''{0}'' - no context provider found.";
    ...
    public static final String QueryRegistry_Error_Inaccessible = "Unable to access argument ''{0}'' of class ''{1}''. Make sure the attribute is PUBLIC.";
    ...
    public static final String RefinedResultBuilder_Error_ColumnsSorting = "Same number of columns and sort directions must be provided.";
    ...
    public static final String ResultRenderer_Error_OutputterNotFound = "No outputter found for format ''{0}'' and type ''{1}''";
    ...
    public static final String TotalsRow_Label_Total = "Total: {0,number,integer} {0,choice,0\\#entries|1\\#entry|1<entries}";
    public static final String TotalsRow_Label_TotalVisible = "Total: {0,number,integer} of {1,number,integer} {1,choice,0\\#entries|1\\#entry|1<entries}; {2,number,integer} more";
