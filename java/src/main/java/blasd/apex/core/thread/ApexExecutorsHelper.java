...
public class ApexExecutorsHelper {
	...
	// blasd.apex.shared.thread.TestApexExecutorsHelper.testBoundedQueueManytasks()
	...
	public static <T> List<? extends ListenableFuture<T>> invokeAll(Collection<? extends Supplier<? extends T>> tasks,
		...
		Collection<Callable<T>> callables = Collections2.transform(tasks, ApexExecutorsHelper.supplierToCallable());
	...
	public static <T> List<? extends ListenableFuture<T>> invokeAll(Collection<? extends Callable<? extends T>> tasks,
		...
		Collection<Callable<T>> callables = Collections2.transform(tasks, ApexExecutorsHelper.<T>callableToCallable());
